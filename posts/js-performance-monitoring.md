...
![Screenshot of the Firefox's profiler report](https://i.imgur.com/cbuctXp.png)
...
![Firefox's profile screenshot for a function that calls multiple sub-functions](https://i.imgur.com/jz4mxUL.png)
